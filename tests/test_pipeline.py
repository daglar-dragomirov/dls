...
def test_invalid_json_is_not_counted_as_a_tool_call():
    records = [
        {
            "expected_call": {"tool_name": "convert_currency", "arguments": {}},
            "prediction": {
                "valid": False,
                "call": {"tool_name": "convert_currency", "arguments": {}},
            },
        }
    ]
    metrics = tool_metrics(records)
    assert metrics["parsable_rate"] == 0.0
